...
# This function reads an image from a topic, transforms it into a numpy array, scales it to a smaller image and finally 
...
if __name__=="__main__":
  rospy.init_node('evaluate_drone_ct', anonymous=True)
  try:
